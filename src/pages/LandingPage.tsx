...
import { CheckCircle2, UsersRound, GraduationCap, Network, HeartPulse, Route, UserRoundSearch, Globe2, Building2, Eye, Activity, Route as RouteIcon, Star, Share2 } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main>
          {/* Hero Section */}
          <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 pt-20 pb-32 bg-gradient-to-b from-background to-secondary/20 overflow-hidden" aria-labelledby="hero-heading">
            <div className="absolute inset-0 z-0">
              <img 
                src="https://img.freepik.com/free-vector/vector-network-background-abstract-polygon-triangle_2065-76.jpg" 
            ...
            <div className="max-w-4xl space-y-10 relative z-10">
              <h1 id="hero-heading" className="text-5xl sm:text-7xl font-bold tracking-tight flex flex-col gap-4">
              ...
              <p className="text-2xl max-w-3xl mx-auto text-center text-slate-950">
                Map relationships with exceptional business leaders, alumni, and wealthy individuals to drive your organization's success.
              </p>
            ...
            <div className="max-w-7xl mx-auto px-4">
              <div className="text-center space-y-6 mb-12">
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  On average, you are only 6 introductions away from your ideal connection. Map this out using RelMaps.
                </p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                <div className="prose prose-gray">
                  ...
                  <p className="text-muted-foreground text-lg leading-relaxed">
                    RelMaps leverages this principle to help you visualize and navigate your extended social and professional networks, making it easier than ever to discover and utilize these powerful connections.
                  </p>
                </div>
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <Card className="bg-background">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-muted-foreground mb-6">
                      "RelMaps has completely transformed how I approach networking. I've made connections I never thought possible, leading to several successful business partnerships."
                    </p>
                ...
                <Card className="bg-background">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-muted-foreground mb-6">
                      "As a recruiter, RelMaps has become an invaluable tool. It's helped me find perfect candidates through unexpected connections and referrals."
                    </p>
                    <div className="flex items-center gap-4">
                      <Avatar>
            ...
            <div className="container max-w-3xl">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger>How does RelMaps work?</AccordionTrigger>
                  <AccordionContent>
