...
const LandingPage = () => {
  return <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 pt-32 pb-48 bg-gradient-to-b from-background to-secondary/20 overflow-hidden">
